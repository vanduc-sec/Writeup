...
![image.png](FFFFAAAATTT-dreamhack/image.png)
...
![image.png](FFFFAAAATTT-dreamhack/image%201.png)
...
![image.png](FFFFAAAATTT-dreamhack/image%202.png)

- Các bạn sẽ copy hết dữ liệu phần này và paste lên section 0 nhé.

 

![image.png](FFFFAAAATTT-dreamhack/image%203.png)

- Sau khi mở nó lên bằng ftk imager thì mình thấy có thư mục dreamhack.

 

![image.png](FFFFAAAATTT-dreamhack/image%204.png)
...
![image.png](FFFFAAAATTT-dreamhack/image%205.png)
