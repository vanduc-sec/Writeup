...
![image.png](the%20missing%20image%20frag%20ment-dh-4/image.png)
...
![image.png](the%20missing%20image%20frag%20ment-dh-4/image%201.png)

Ở 1 trong các file bị xóa mọi người sẽ thấy có 1 đoạn mã base64 vô cùng đáng nghi nên mình mang nó đi decode 

![image.png](the%20missing%20image%20frag%20ment-dh-4/image%202.png)
...
![image.png](the%20missing%20image%20frag%20ment-dh-4/image%203.png)

offest bắt đầu file zip: 5f8161

![image.png](the%20missing%20image%20frag%20ment-dh-4/image%204.png)

Kết thúc file zip: 5fca3a

![image.png](the%20missing%20image%20frag%20ment-dh-4/image%205.png)
